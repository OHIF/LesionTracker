...
LesionTableProto.createdCallback = function () {
   ...
   // var heightAttr  = "250px"; //Default height
    ...
    shadowEl.refreshTableAfterDragDrop = function (thumbnailId,captionTxt) {
        ...
        captionTxt =  captionTxt.replace("<", "&lt").replace(">", "&gt");
    ...
    //Set lesion-table height & width
    shadowEl.setTableHeight = function (width,height){

        shadowEl.querySelector("#table-container").style.height = (height-20)+"px";
        shadowEl.querySelector("#table-container").style.width = width + "px";
        shadowEl.querySelector("#tblLesion").style.height = (height-40) + "px";
        shadowEl.querySelector("#tblLesion").style.width = width + "px";
    };
